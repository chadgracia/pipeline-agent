    ...
    },
    {
        "toolSpec": {
            ...
            "inputSchema": {"json": {"type": "object", "properties": {
                ...
                "min_size": {"type": "number", "description": "Minimum deal size in dollars. 'Ticket', 'ticket size', or 'min ticket' refer to deal size — map a minimum ticket here."},
                "max_size": {"type": "number", "description": "Maximum deal size in dollars. 'Ticket', 'ticket size', or 'max ticket' refer to deal size — map a maximum ticket here. A single ticket figure with no min/max qualifier (e.g. 'ticket of $5M') is the minimum."},
